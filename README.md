...
* scripts/calli.js : code that will house logic for calling file functions and using their responses
...
### Running callyBot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start callyBot locally by running:
...
Then you can interact with callyBot by typing `callyBot help`.

    callyBot> callyBot help
    callyBot animate me <query> - The same thing as `image me`, except adds [snip]
    callyBot help - Displays all of the help commands that callyBot knows about.
    ...
